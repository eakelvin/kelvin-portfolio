        ...
        <section id="projects" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24">
            ...
            <ul className="group/list">
                {projects.map((project) => {
                    const isComingSoon = project.status.toLowerCase().includes("coming");
                    const primaryHref = project.website || project.github;

                    return (
                        <li
                            key={project.title}
                            className={`mb-12 ${isComingSoon ? "opacity-55" : ""}`}
                        >
                                ...
                                <div className="z-10 sm:col-span-6">
                                    <h3 className="font-medium leading-snug text-slate-200">
                                        {primaryHref ? (
                                            ...
                                            <span className="text-base leading-tight text-slate-200">
                                                {project.title}
                                            </span>
                                        )}
                                    </h3>
